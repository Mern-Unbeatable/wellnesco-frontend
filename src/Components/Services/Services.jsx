export default function Services() {
  ...
  return (
    <section className="bg-white py-[6rem] px-[5%]" id="services">
      <div className="max-w-[1360px] mx-auto">
        <div className="flex items-end justify-between mb-[2rem] rv">
          <div>
            <div className="text-[0.67rem] font-bold tracking-[0.12em] uppercase text-gold mb-[0.6rem]">Services</div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[1.2rem] rv">
          {servicesData.map((svc, i) => (
            <div key={i} className="rounded-[var(--radius-rl)] overflow-hidden cursor-pointer transition duration-250 bg-white shadow-sh border border-[rgba(154,114,72,0.07)] hover:-translate-y-[6px] hover:shadow-sm">
              <img className="w-full h-[180px] object-cover block bg-cream" src={svc.img} alt={svc.name} loading="lazy" />
