    ...
    <section className="bg-white p-0" id="providers">
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[600px]">
        <div className="relative overflow-hidden h-[300px] lg:h-auto rv">
          ...
          />
          <div className="absolute inset-0 bg-linear-to-r from-transparent to-[rgba(255,255,255,0.05)]"></div>
        </div>

        <div className="bg-cream p-[5rem_5%] lg:p-20 flex flex-col justify-center rv d2">
          ...
          <p className="text-[0.97rem] text-soft leading-[1.7] max-w-[500px] mt-[0.7rem]">
            Whether you're an RN with evenings free, a Pilates instructor
            building your client base, or a massage therapist going independent
            — WellnessGo is your complete business infrastructure.
          </p>

          <div className="bg-white rounded-rl p-[20px] shadow-sm mt-8 mb-8 max-w-[400px]">
            <div className="text-[0.57rem] text-muted uppercase tracking-[0.06em] mb-[2px]">
              Sample monthly earnings
            </div>
            <div className="font-serif text-[2.2rem] text-deep mb-[2px]">
              $4,820
            </div>
            <div className="text-[0.73rem] text-soft mb-[14px]">
              Registered Nurse · IV Specialist · Los Angeles
            </div>
            ...
            <div className="mb-[7px]">
              ...
              <div className="h-[5px] bg-warm rounded-full overflow-hidden">
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(90deg,var(--color-gold),var(--color-sage))",
                  }}
                ></div>
              </div>
            </div>
            ...
            <div className="mb-[7px]">
              ...
              <div className="h-[5px] bg-warm rounded-full overflow-hidden">
                <div
                  className="h-full rounded-full w-[33%]"
                  style={{
                    background:
                      "linear-gradient(90deg,var(--color-gold),var(--color-sage))",
                  }}
            ...
            <div className="mb-0">
              ...
              <div className="h-[5px] bg-warm rounded-full overflow-hidden">
                <div
                  className="h-full rounded-full w-[19%]"
                  style={{
                    background:
                      "linear-gradient(90deg,var(--color-gold),var(--color-sage))",
                  }}
          ...
          <div className="flex gap-3 flex-wrap">
            <button
              onClick={scrollToApp}
              className="bg-deep text-white border-none rounded-full p-[0.8rem_1.8rem] font-sans text-[0.9rem] font-bold cursor-pointer transition duration-200 hover:bg-gold"
            >
              Apply as a provider →
            </button>
          ...
          <p className="text-[0.78rem] text-muted mt-[0.85rem]">
            85% revenue split · Direct bank deposit within 24h · Full schedule
            control
          </p>
        </div>
      </div>
