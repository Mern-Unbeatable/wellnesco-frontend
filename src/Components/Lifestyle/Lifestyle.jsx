  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[520px] rv">
      <div className="relative overflow-hidden h-[300px] lg:h-auto">
        ...
        />
        <div className="absolute inset-0 bg-linear-to-r from-[rgba(42,26,14,0.3)] to-transparent"></div>
      </div>
      <div className="bg-cream flex items-center p-[5rem_5%] lg:p-20">
        <div>
          ...
          <ul className="list-none mt-6 flex flex-col gap-[0.85rem]">
            <li className="flex items-start gap-[0.85rem] text-[0.9rem] text-mid leading-normal">
              <span className="w-[36px] h-[36px] rounded-[10px] bg-white shadow-sh flex items-center justify-center text-[1rem] shrink-0">
                <Zap size={18} className="text-gold" />
              </span>
              <div>
                <strong className="text-deep text-[0.88rem]">
                  Instant Rebooking
                </strong>
                <br />
            ...
            <li className="flex items-start gap-[0.85rem] text-[0.9rem] text-mid leading-normal">
              ...
              <div>
                ...
                <br />
                &quot;Your stress indicators are elevated. Breathwork · IV ·
                Stretch. Tap to book.&quot;
              </div>
            </li>
            <li className="flex items-start gap-[0.85rem] text-[0.9rem] text-mid leading-normal">
              ...
              <div>
                ...
                <br />
                Can&apos;t receive at home? We arrange a luxury transfer to a
                partner suite.
              </div>
            </li>
          </ul>
