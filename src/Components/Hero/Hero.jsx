    ...
    <section className="pt-[66px] bg-cream min-h-[96vh] flex flex-col relative overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-2 flex-1 max-w-[1360px] mx-auto w-full px-[5%]">
        <div className="flex flex-col justify-center py-16 lg:pr-12">
          <div className="inline-flex items-center gap-[0.45rem] bg-sagedim border border-[rgba(122,143,88,0.2)] rounded-full px-[0.8rem] py-1 text-[0.68rem] font-bold tracking-[0.09em] uppercase text-sage mb-6 self-start">
          ...
          <h1 className="font-serif text-[clamp(3rem,4.8vw,5rem)] font-normal leading-[1.06] tracking-[-0.025em] text-deep mb-[1.3rem]">
            Your luxury
            <br />
            wellness <i className="italic text-gold">concierge.</i>
            <br />
            At home.
          </h1>

          <p className="text-[1.05rem] text-soft leading-[1.75] max-w-[430px] mb-8">
            Licensed nurses, Pilates instructors, concierge doctors,
            aestheticians and more — delivered to your door. After hours. On
            demand. Always safe.
          </p>

          <div className="flex gap-2 mb-[1.6rem] flex-wrap">
            <input
        ...
        <div className="relative overflow-hidden hidden lg:block">
          ...
          <div className="absolute bottom-10 left-10 bg-white/95 rounded-(--radius-r) px-[16px] py-[13px] shadow-sm backdrop-blur-[10px]">
            <div className="flex items-center gap-[9px]">
              <div className="flex">
                <div
                  className="w-[28px] h-[28px] rounded-full border-2 border-white object-cover -mr-[8px] bg-cream"
                  style={{
                    background: "linear-gradient(135deg,#9a7248,#c4897a)",
                  }}
                ></div>
                <div
                  className="w-[28px] h-[28px] rounded-full border-2 border-white object-cover -mr-[8px] bg-cream"
                  style={{
                    background: "linear-gradient(135deg,#7a8f58,#a0b878)",
                  }}
                ></div>
                <div
                  className="w-[28px] h-[28px] rounded-full border-2 border-white object-cover -mr-[8px] bg-cream"
                  style={{
                    background: "linear-gradient(135deg,#5a3e28,#9a7248)",
                  }}
                ></div>
              </div>
              <div>
                <strong className="text-[0.78rem] text-deep block">
                  2,400+ providers
                </strong>
                <span className="text-[0.65rem] text-soft">
                  available near you
                </span>
              </div>
            </div>
            <div className="text-[0.65rem] text-gold mt-[4px]">
              ★★★★★ &nbsp;4.9 average rating
            </div>
          </div>

          <div className="absolute bottom-10 right-10 bg-white/95 rounded-full px-[0.9rem] py-[0.38rem] shadow-sh flex items-center gap-[0.45rem] text-[0.72rem] font-semibold text-sage before:content-[''] before:w-[7px] before:h-[7px] before:rounded-full before:bg-sage before:animate-pulse-fast">
            Available tonight
          </div>
        </div>
      </div>
